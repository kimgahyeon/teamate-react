  ...
  <>
    <MateSection>
      <MateLeft>
        ...
        <MateIntroduce>
          안녕하세요 자기소개입니다. 많이 품고 있는 이상! 이것이야말로 무한한
          가치를 가진 것이다 사람은 크고 작고 간에 이상이 있음으로써 용감하고 굳
          세게 살 수 있는 것이다 석가는 무엇을 위하여 설산에서 고행을 하였으며
          예수는 무엇을 위하여 광야에서 방황하였으며많이 품고 있는 이상!
          이것이야말로 무한한 가치를 가진 것이다 사람은 크고 작고 간에 이상이
          있음으로써 용감하고 굳세게 살 수 있는 것이다 석가는 무엇을 위하여
          설산에서 고행을 하였으며 예수는 무엇을 위하여 광야에서 방황하였으며
          <br />
          <br />
      ...
      <MateRight>
        ...
        <MateProfile style={{ backgroundImage: `url(${ogu})`, backgroundPositionX: "-120px", backgroundPositionY: "-50px"} }>{/* 프사 */}</MateProfile>
    ...
    <MateProjectSection>
      ...
      { projects? console.log(projects) : console.log("없어요")}
